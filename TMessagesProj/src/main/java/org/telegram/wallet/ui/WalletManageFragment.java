...
public class WalletManageFragment extends Fragment implements WalletRefreshable {
    ...
    @Override public android.view.View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        FrameLayout icon = Web3Ui.iconCircleDrawable(getActivity(), R.drawable.icon_wallet_6_1, p.dark ? 0x26F08C22 : 0xFFFFF2DF, 38);
        ...
        FrameLayout deco = Web3Ui.iconCircleDrawable(getActivity(), R.drawable.icon_wallet_2_1, p.dark ? 0x1AF08C22 : 0xFFFFF2DF, 46);
        ...
        LinearLayout walletList = Web3Ui.actionButtonDrawable(getActivity(), LocaleController.getString(R.string.Web3WalletListSwitchTitle), R.drawable.icon_wallet_6_3, true);
        ...
        LinearLayout tokenList = Web3Ui.actionButtonDrawable(getActivity(), LocaleController.getString(R.string.WalletTokenList), R.drawable.icon_wallet_5_1, false);
        tokenList.setOnClickListener(v -> startTokenListPage(false, false));
        card.addView(tokenList, Web3Ui.topMargin(getActivity(), 10));
        LinearLayout redPacketRecords = Web3Ui.actionButtonDrawable(getActivity(), LocaleController.getString(R.string.WalletMyRedPacketRecords), R.drawable.icon_wallet_3_1, false);
