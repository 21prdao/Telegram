...
public class DarkThemeResourceProvider implements Theme.ResourcesProvider {
    ...
    public DarkThemeResourceProvider() {
        ...
        sparseIntArray.put(Theme.key_dialogButton, 0xFFEFAB64);
...
//        sparseIntArray.put(Theme.key_chat_messagePanelSend, Color.WHITE);
        ...
        sparseIntArray.put(Theme.key_chat_recordedVoiceBackground, 0xFFFF931A);
        sparseIntArray.put(Theme.key_chat_messagePanelVoiceDuration, -1);
        sparseIntArray.put(Theme.key_chat_recordTime, 2030043135);
        sparseIntArray.put(Theme.key_chat_recordVoiceCancel, 0xFFECAE5D);
        ...
        sparseIntArray.put(Theme.key_chat_messageLinkOut, 0xFFFFD6AE);
        ...
        sparseIntArray.put(Theme.key_progressCircle, 0xFFFDBB64);
        sparseIntArray.put(Theme.key_chat_emojiPanelStickerPackSelector, 0x0AFFE7CD);
        ...
        sparseIntArray.put(Theme.key_chat_emojiPanelStickerPackSelectorLine, 0xFFEFAB64);
        ...
        sparseIntArray.put(Theme.key_chat_editMediaButton, 0xFFFF931A);
        ...
        sparseIntArray.put(Theme.key_undo_cancelColor, 0xFFF5C28B);
        ...
        sparseIntArray.put(Theme.key_groupcreate_cursor, 0xFFEFAB64);
        ...
        sparseIntArray.put(Theme.key_fastScrollActive, 0xFFE99737);
        sparseIntArray.put(Theme.key_fastScrollText, 0xffffffff);
        sparseIntArray.put(Theme.key_featuredStickers_addButton, 0xFFFF931A);
        sparseIntArray.put(Theme.key_dialogTextLink, 0xFFEFAB64);
        sparseIntArray.put(Theme.key_dialogSearchText, Color.WHITE);
        sparseIntArray.put(Theme.key_chat_messageLinkIn, 0xFFEB9E46);
        ...
        sparseIntArray.put(Theme.key_location_actionActiveIcon, 0xFFFCBE79);
        ...
        sparseIntArray.put(Theme.key_radioBackgroundChecked, 0xFFEFAB64);
        sparseIntArray.put(Theme.key_checkboxDisabled, -12237499);
        sparseIntArray.put(Theme.key_checkboxCheck, 0xFFFFFFFF);

        sparseIntArray.put(Theme.key_avatar_backgroundSaved, 0xFFF6B45C);
        sparseIntArray.put(Theme.key_avatar_background2Saved, 0xFFCF9240);
        ...
        sparseIntArray.put(Theme.key_player_progress, 0xFFEFA253);
